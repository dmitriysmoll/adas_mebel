...
<table style="border-color: #cadce8;width: 100%;max-width: 700px;">
    ...
    <tr IF="isPaymentShippingSectionVisible()">
      <td IF="isShippingSectionVisible()" style="padding-top: 20px;padding-right: 15px;width: 90%;font-size: 15px;vertical-align: top;">
      ...
      <td IF="isPaymentSectionVisible()" style="padding-top: 20px;padding-right: 0px;width: 50%;font-size: 15px;vertical-align: top;">
        <div style="position: relative;min-width: 300px;background: #f9f9f9;height: 330px;border-radius: 6px;padding: 20px;">
