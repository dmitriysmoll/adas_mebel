...
<div class="admin-warning-block">
  ...
  <div>Если Вы хотите увидеть больше возможностей, создайте бесплатно <a href="http://my.x-cart.com/create_store" target="_blank">временную учетную запись</a> <span class="nowrap">X-Cart Cloud</span> или <a href="http://www.x-cart.ru/" target="_blank">скачайте</a> и установите <span class="nowrap">X-Cart 5.</span></div>
