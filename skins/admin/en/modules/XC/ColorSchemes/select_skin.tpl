...
<div class="more-templates"><a href="http://www.x-cart.com/extensions/xcart-templates.html?sl={%XLite::getInstallationLng()%}" target="_blank">{t(#More templates#)}</a> <i class="icon fa fa-external-link"></i></div>
