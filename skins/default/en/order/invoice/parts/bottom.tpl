...
<ul cellspacing="0" class="addresses">
  ...
  <li IF="isShippingSectionVisible()" class="address shipping">
  ...
  <li IF="isPaymentSectionVisible()" class="address payment{if:isShippingSectionVisible()} payment-wrapping{end:}">
    <div class="wrapper">
