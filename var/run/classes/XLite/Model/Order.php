...
class Order extends \XLite\Model\Base\SurchargeOwner
{
    ...
    public function processSucceed()
    {
        ...
        $status = $this->getPaymentStatusCode();
    ...
    {
        if ($this->getPaymentStatusCode() == \XLite\Model\Order\Status\Payment::STATUS_QUEUED) {
            $this->setPaymentStatus(\XLite\Model\Order\Status\Payment::STATUS_DECLINED);
        }
