...
class Order extends \XLite\Model\Order implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'order_id', 'shipping_id', 'shipping_method_name', 'payment_method_name', 'tracking', 'date', 'lastRenewDate', 'notes', 'adminNotes', 'orderNumber', 'total', 'subtotal', 'profile', 'orig_profile', 'paymentStatus', 'shippingStatus', 'details', 'trackingNumbers', 'events', 'items', 'surcharges', 'payment_transactions', 'currency');
    }
