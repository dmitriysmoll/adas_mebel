...
class Product extends \XLite\Model\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'ogMeta', 'useCustomOG', 'product_id', 'price', 'sku', 'enabled', 'weight', 'useSeparateBox', 'boxWidth', 'boxLength', 'boxHeight', 'itemsPerBox', 'free_shipping', 'taxable', 'javascript', 'arrivalDate', 'date', 'updateDate', 'attrSepTab', 'cleanURL', 'featuredProducts', 'categoryProducts', 'order_items', 'images', 'inventory', 'productClass', 'taxClass', 'attributes', 'attributeValueC', 'attributeValueT', 'attributeValueS', 'quickData', 'memberships', 'translations');
    }
