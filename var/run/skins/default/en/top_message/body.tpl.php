<div id="status-messages" <?php if ($this->isHidden()){?> style="display: none;"<?php }?>>
  ...
  <a href="#" class="close" title="<?php echo func_htmlspecialchars($this->t('Close')); ?>"><img src="skins/default/en/images/spacer.gif" alt="<?php echo func_htmlspecialchars($this->t('Close')); ?>" /></a>
