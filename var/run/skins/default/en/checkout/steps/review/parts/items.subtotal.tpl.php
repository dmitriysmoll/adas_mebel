<div class="items-row clearfix">
  <?php echo $this->t('_X items_ in bag',array('count'=>$this->get('cart')->countQuantity())); ?>
  <span class="price<?php if ($this->get('cart')->getItemsIncludeSurchargesTotals()){?> modified-subtotal<?php }?>"><?php $this->getWidget(array('surcharge' => $this->get('cart')->getSubtotal(), 'currency' => $this->get('cart')->getCurrency()), 'XLite\View\Surcharge')->display(); ?></span>
