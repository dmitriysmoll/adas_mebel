...
class Install extends \XLite\View\ItemsList\Module\AModule
{
    ...
    {
        return \XLite\Core\Request::getInstance()->clearCnd ? '' : $this->getParam(static::PARAM_TAG);
    }
    ...
    protected function getSearchCondition()
    {
        if ($this->isLandingPage()) {
            ...
            if (isset(\XLite\Core\Request::getInstance()->{\XLite\View\Pager\Admin\Module\AModule::PARAM_CLEAR_PAGER})) {
                $cnd->{\XLite\Model\Repo\Module::P_ORDER_BY} = array(static::SORT_OPT_ALPHA, static::SORT_ORDER_ASC);
            }
        }
            ...
            if ($this->isCurlAvailable()) {
                ...
                if ($this->isOpenSSLAvailable()) {
                    ...
                    if (!defined('CURLE_SSL_ENGINE_INITFAILED')) {
                        define('CURLE_SSL_ENGINE_INITFAILED', 55);
                    }
            ...
            if ($tag && !$this->isLandingPage()) {
                ...
                if (isset($tags[$tag])) {
                    ...
                    if (
                        ...
                        && $tagInfo[\XLite\Core\Marketplace::FIELD_TAG_MODULE_BANNER]
                        ...
                        $this->bannerInfo = array(
                            ...
                            'module_banner_url' => $this->getBannerURL($tagInfo[\XLite\Core\Marketplace::FIELD_TAG_MODULE_BANNER]),
                        );
                    }
                }
            }
    ...
    protected function isPromoBannerActive($date)
    {
        ...
        return '' === $date || $timestamp > \XLite\Core\Converter::time();
    }
