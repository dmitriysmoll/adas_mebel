...
abstract class Main extends \XLite\Module\AModule
{
    ...
    {
        return array(
            'product/inventory/inv_track_amount.tpl' => array('product.inventory.parts', 'admin'),
            'product/inventory/inv_track_selector.tpl' => array('product.inventory.parts', 'admin')
        );
    }
}
