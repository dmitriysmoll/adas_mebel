...
namespace XLite\Module\PerceptionSystemPvtLtd\ProductVideo;
...
abstract class Main extends \XLite\Module\AModule
{
    ...
    {
        return 'Perception System Pvt. Ltd.';
    }
    ...
    {
        return 'http://www.perceptionsystem.com';
    }
    ...
    {
        return 'Allows you to add youtube video to your product on product-details page.';
    }

	/**
     * Determine if we need to display product view
     *
     * @param \XLite\Model\Product $product Current product
     *
     * @return boolean
     */
    public static function isShowProductVideo(\XLite\Model\Product $product)
    {
        return \XLite\Module\Perception\ProductVideo\Main::isShowProductVideo($product);
    }
