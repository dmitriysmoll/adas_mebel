 ...
 *
 */
class Rating extends \XLite\View\VoteBar
{
    /**
     * Widget param name
     */
    ...
    {
        return $this->getParam(static::PARAM_IS_EDITABLE) ? ' editable' : ' non-editable';
    }
    ...
    {
        return 'modules/XC/Reviews/form_field/input/rating/rating.tpl';
    }
