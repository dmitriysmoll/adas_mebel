...
class Review extends \XLite\View\ItemsList\Model\Table
{
    ...
    public function getJSFiles()
    {
        ...
        $list[] = 'modules/XC/Reviews/form_field/input/autocomplete/email.js';
        $list[] = 'modules/XC/Reviews/form_field/input/autocomplete/reviewer_name.js';
        $list[] = 'modules/XC/Reviews/form_field/input/autocomplete/product.js';
