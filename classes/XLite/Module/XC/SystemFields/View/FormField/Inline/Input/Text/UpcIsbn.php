...
namespace XLite\Module\XC\SystemFields\View\FormField\Inline\Input\Text;

/**
 * UPC/ISBN
 */
class UpcIsbn extends \XLite\View\FormField\Inline\Input\Text
{
    /**
     ...
     * @return array
     */
    protected function validateUpcIsbn(array $field)
    {
        $result = array(true, null);

        try {
            $productVariant = $this->getEntity();
            $validator = new \XLite\Module\XC\SystemFields\Core\Validator\VariantUpcIsbn(
