 ...
 */
class VariantUpcIsbn extends \XLite\Core\Validator\AValidator
{
    /**
     * Id (saved)
     *
    ...
    public function validate($data)
    {
        if (!\XLite\Core\Converter::isEmptyString($data)) {
            ...
            if (
                ...
                || \XLite\Core\Database::getRepo('XLite\Model\Product')->findOneByUpcIsbn($this->sanitize($data))
            ) {
