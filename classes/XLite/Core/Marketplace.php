...
class Marketplace extends \XLite\Base\Singleton
{
    ...
    const ACTION_ACTIVATE_FREE_LICENSE = 'activate_free_license';
    ...
    {
        return 'http://www.x-cart.com/contact-us.html?sl=' . \XLite::getInstallationLng();
    }
    ...
    {
        return 'http://www.x-cart.com/license-agreement.html?sl=' . \XLite::getInstallationLng();
    }
    ...
    public function doTestMarketplace()
    {
        ...
        return !is_null($this->performActionWithTTL(0, static::ACTION_CHECK_FOR_UPDATES, $this->getCheckForUpdatesData(), false));
    }
